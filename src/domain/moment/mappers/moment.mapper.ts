        ...
        if (sequelizeMoment.metrics) {
            momentData.metrics = {
                views: {
                    ...
                    repeatViews: sequelizeMoment.metrics.repeatViews,
                ...
                performance: {
                    ...
                    qualitySwitches: sequelizeMoment.metrics.qualitySwitches,
                    bandwidthUsage: 0,
                    averageBitrate: 0,
                    peakBitrate: 0,
                    processingTime: 0,
                ...
                viral: {
                    ...
                    trendingScore: sequelizeMoment.metrics.trendingScore,
                    reachScore: sequelizeMoment.metrics.reachScore,
                    influenceScore: sequelizeMoment.metrics.influenceScore,
                    growthRate: sequelizeMoment.metrics.growthRate,
                    accelerationRate: 0,
                    peakGrowthTime: new Date(),
                    organicReach: 0,
                    paidReach: 0,
                    viralReach: 0,
                    totalReach: sequelizeMoment.metrics.totalReach,
                    reachByPlatform: {},
                    reachByUserType: {},
                    cascadeDepth: 0,
                },
                ...
                content: {
                    contentQualityScore: sequelizeMoment.metrics.contentQualityScore,
                    audioQualityScore: sequelizeMoment.metrics.audioQualityScore,
                    videoQualityScore: sequelizeMoment.metrics.videoQualityScore,
                    faceDetectionRate: sequelizeMoment.metrics.faceDetectionRate,
                    motionIntensity: 0,
                    colorVariance: 0,
                    brightnessLevel: 0,
                ...
                createdAt: sequelizeMoment.metrics.createdAt,
                updatedAt: sequelizeMoment.metrics.updatedAt,
            }
        }
